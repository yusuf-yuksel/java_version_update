...
public class CollectorsDemo {
    public static void main(String[] args) {
        List<Integer> numbers = Arrays.asList(3,5,62,34,123,6,36);
        ...
        Double calerieAverage = DishData.getAll().stream()
                .collect(Collectors.averagingInt(Dish::getCalories));
        System.out.println(calerieAverage);
        ...
        Map<Boolean, List<Dish>> vegeterian = DishData.getAll().stream()
